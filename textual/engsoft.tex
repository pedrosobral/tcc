...
%   \item[Node.js]
%   \item[MongoDB]
%   \item[\textit{Ionic}] é um \textit{framework open-source} para o desenvolvimento de aplicativos
...
%   \textit{iOS}, \textit{Android} e \textit{Windows}, que aliás foi uma das razões que fez o Moodle
