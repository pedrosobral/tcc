...
\chapterprecis{Neste capítulo inicialmente é
apresentado o conceito de aprendizado ativo e um método de implementação.
Em seguida é apontado os {\clickers} como uma
...
Dessa forma, \citeonline{Velasco2013} aconselha os {\clickers} como uma ferramenta opcional para
os estudantes.
