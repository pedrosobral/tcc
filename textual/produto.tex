\chapter{Resposta em Sala de Aula}\label{chap:rsa}\stepcounter{numchapters}
...
\begin{figure}[H]
  ...
  \subfloat[Botão para responder a chamada]{
    \includegraphics[scale=.30]{imagens/telas/student_freq1}
    \label{fig:freqa}
  }$\quad$
  \subfloat[Tela com campo para digitar código] {
    \includegraphics[scale=.30]{imagens/telas/student_freq2}
    \label{fig:freqb}
  }
...
\begin{figure}[H]
  ...
  \subfloat[Questão do tipo múltipla escolha]{
    \includegraphics[scale=.25]{imagens/telas/student_question1}
...
O software desenvolvido neste trabalho é um software livre sob a licença MIT,
