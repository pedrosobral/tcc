...
A turma era composta por um professor e 13 alunos, com faixa etária entre 19 e 33 anos, 3 (23\%)
...
A \autoref{tab:sus_result_students} apresenta as respostas dos 12 participantes.
...
Seguinda a classificação da \autoref{fig:sus_score}, o aplicativo dos estudantes pode ser classificado com nota entre 90-99 como \textit{aceitável, A e Excelente (``Excellent'')}.
Assim, pode-se dizer que o software apresenta os cinco componentes de qualidade de usabilidade definidos
por \citeonline{nielsen_2012}, ou seja, apreensibilidade, eficiência, recordação, erros e satisfação
de forma ``excelente''.
...
No entanto, isso indicou um novo requisito no sistema, que é também permitir ao professor mostrar
...
\begin{enumerate}[leftmargin=*]
  ...
  \begin{itemize}[label={},leftmargin=*]
    ...
    daí podesse fazer um questionamento depois da explicação. Outra coisa, é interessante fazer logo no início da aula umas 3 questões
...
Em síntese, o professor avaliou de forma positiva o uso do aplicativo como instrumento para aulixá-lo
