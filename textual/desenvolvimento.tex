...
Em resumo, o aprendizado ativo é uma metodologia que além de envolver os estudantes no fazer, os faça pensar no que estão fazendo \cite[p. 19]{Charles1991}.
...
São muitas são as adversidades de infraestrutura e institucionais
